    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <template v-if="goodsData?.categories?.length">
            <el-breadcrumb-item :to="{ path: `/category/${goodsData.categories[0].id}` }">{{goodsData.categories[0].name}}</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: `/category/sub/${goodsData.categories[1].id}` }">{{goodsData.categories[1].name}}</el-breadcrumb-item>
          </template>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-img-lazy="item" v-for="item in goodsData.details?.pictures" />
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
