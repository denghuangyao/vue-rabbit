...
<template>
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @click="toggleDialog.show()">切换地址</el-button>
  ...
  <!-- 切换地址 -->
   <XtxDialog ref="toggleDialog" title="切换收货地址" @cancel="toggleCancel" @confirm="toggleConfirm">
